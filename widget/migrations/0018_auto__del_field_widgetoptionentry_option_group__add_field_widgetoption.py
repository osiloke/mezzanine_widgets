...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WidgetOptionEntry.option_group'
        db.delete_column('widget_widgetoptionentry', 'option_group_id')

        # Adding field 'WidgetOptionEntry.widget'
        db.add_column('widget_widgetoptionentry', 'widget', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='options', to=orm['widget.Widget']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WidgetOptionEntry.option_group'
        db.add_column('widget_widgetoptionentry', 'option_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='options', to=orm['widget.WidgetOptionGroup']), keep_default=False)

        # Deleting field 'WidgetOptionEntry.widget'
        db.delete_column('widget_widgetoptionentry', 'widget_id')
    ...
    models = {
        ...
        'widget.widgetoptiongroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'widget': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'option_group'", 'to': "orm['widget.Widget']"})
        },
        'widget.widgetslot': {
