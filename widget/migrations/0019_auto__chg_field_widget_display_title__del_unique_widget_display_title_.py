...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WidgetOptionGroup.widget'
        db.alter_column('widget_widgetoptiongroup', 'widget_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['widget.Widget']))

        # Adding unique constraint on 'WidgetOptionGroup', fields ['widget']
        db.create_unique('widget_widgetoptiongroup', ['widget_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'WidgetOptionGroup', fields ['widget']
        db.delete_unique('widget_widgetoptiongroup', ['widget_id'])

        # Changing field 'Widget.display_title'
        db.alter_column('widget_widget', 'display_title', self.gf('django.db.models.fields.CharField')(default='Widget', max_length=255, unique=True))

        # Adding unique constraint on 'Widget', fields ['display_title']
        db.create_unique('widget_widget', ['display_title'])

        # Changing field 'WidgetOptionGroup.widget'
        db.alter_column('widget_widgetoptiongroup', 'widget_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['widget.Widget']))
    ...
    models = {
        ...
        'widget.widget': {
            ...
            'display_title': ('django.db.models.fields.CharField', [], {'default': "'Widget'", 'max_length': '255', 'null': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
