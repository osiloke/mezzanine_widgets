...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Widget.widgetslot' to match new field type.
        db.rename_column('widget_widget', 'widgetslot_id', 'widgetslot')
        # Changing field 'Widget.widgetslot'
        db.alter_column('widget_widget', 'widgetslot', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Removing index on 'Widget', fields ['widgetslot']
        db.delete_index('widget_widget', ['widgetslot_id'])


    def backwards(self, orm):
        
        # Adding index on 'Widget', fields ['widgetslot']
        db.create_index('widget_widget', ['widgetslot_id'])

        # Renaming column for 'Widget.widgetslot' to match new field type.
        db.rename_column('widget_widget', 'widgetslot', 'widgetslot_id')
        # Changing field 'Widget.widgetslot'
        db.alter_column('widget_widget', 'widgetslot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['widget.WidgetSlot'], null=True))
    ...
    models = {
        ...
        'widget.widgetoptionentry': {
            ...
            'option_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'options'", 'to': "orm['widget.WidgetOptionGroup']"}),
