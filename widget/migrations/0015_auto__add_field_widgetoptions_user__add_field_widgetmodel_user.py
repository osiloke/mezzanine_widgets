...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'widget.widgetmodel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'widgetmodels'", 'to': "orm['auth.User']"}),
        ...
        'widget.widgetoptions': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'widgetoptionss'", 'to': "orm['auth.User']"}),
            'widget': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['widget.Widget']"})
        },
        'widget.widgetslot': {
